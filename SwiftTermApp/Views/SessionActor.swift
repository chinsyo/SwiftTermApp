...
typealias DisconnectCallback = @convention(c) (UnsafeRawPointer, CInt,
...
actor SessionActor {
    ...
    init(send: @escaping SocketCallback, recv: @escaping SocketCallback, disconnect: @escaping DisconnectCallback, debug: @escaping DebugCallback, opaque: UnsafeMutableRawPointer, retHandle: inout OpaquePointer?) {
        libssh2_init(0)
